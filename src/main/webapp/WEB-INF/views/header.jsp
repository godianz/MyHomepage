...
<div id="mySidenav" class="sidenav">
	...
	<button class="dropdown-btn">
		Diary <i class="fa fa-caret-down"></i>
	</button>
	<div class="dropdown-container">
		<a href="/diary">개발노트</a>
	</div>
	<button class="dropdown-btn">
		Photo <i class="fa fa-caret-down"></i>
	</button>
	<div class="dropdown-container">
		<a href="/photo">여행</a>
	</div>
...
<div class="head">
	<div class="item1">
		<div class="bar_div">
			<span id="menu_bar" style="font-size: 30px; cursor: pointer"
				onclick="openNav()">&#9776;</span> <input type="button"
				value="Login" id="login_btn" onclick="showPopup();" /> <input
				type="button" value="friendZone" />
		</div>
		<h1>
			<a href="/main">이 안의 삶</a>
		</h1>
	</div>
	<hr>
</div>
